...
\begin{table}[H]
\centering
\caption{Distribution comparison tests for guild size data using complete Appendix 7.1 dataset. 
Positive $R$ favors power law; negative $R$ favors the alternative. 
...
Alternative & $R$ & $p$ & Interpretation \\
\midrule
Lognormal & $-0.90$ & 0.340 & No significant difference \\
Exponential & 1.25 & 0.657 & Power law favored, not significant \\
Stretched exponential & $-1.07$ & 0.319 & No significant difference \\
Truncated power law & $-1.29$ & 0.108 & No significant difference \\
\bottomrule
\end{tabular}
\end{table}
